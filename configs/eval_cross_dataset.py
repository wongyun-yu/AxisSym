"""Evaluation config for cross-dataset testing (LDRS / SDRW).
Set dataset to 'ldrs' or 'sdrw' to evaluate on the respective test set.
"""
...
class Config:
    ...
    # Dataset parameters — change to 'ldrs' or 'sdrw'
    dataset: Optional[str] = "ldrs"
