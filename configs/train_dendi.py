"""Training config for DENDI dataset with data augmentation.
Joint reflection + rotation symmetry detection.
D8-equivariant ResNet-34 with orientational anchors and multi-scale matching.
"""
...
class Config:
    ...
    # Logging parameters
    run_name: Optional[str] = "train_dendi"
